...
namespace SV21T1020777.DataLayers
{
    public interface IProductDAL
    {
        ...
        /// <summary>
        /// Kiểm tra xem DislayOrder có bị trùng hay không?
        /// </summary>
        /// <param name="productId"></param>
        /// <param name="displayOrder"></param>
        /// <returns></returns>
        bool CheckPhotoDisplayOrderExists(int productId, int displayOrder);
        bool CheckAttributeDisplayOrderExists(int productId, int displayOrder);
    }
}
